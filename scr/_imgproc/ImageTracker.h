...
struct TrackedObject
{
    ...
    QPointF modelPositionMillimeters; // fixed model axes: +x toward M1, +y upward
...
struct TrackingResult
{
    ...
    double completedAtSteadySeconds = 0.0;
...
// replaced. fastResultReady feeds the control loop, while
...
public:
    ...
    void setMillimeterTransform(const MillimeterTransform &displayTransform,
...
private:
    ...
    double m_pendingSubmittedAtSteadySeconds = 0.0;
    bool m_hasPendingFrame = false;
    bool m_stopping = false;
    ImageProcessingSettings m_settings;
    MillimeterTransform m_millimeterTransform;
    MillimeterTransform m_modelMillimeterTransform;
